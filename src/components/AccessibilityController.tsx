...
export const AccessibilityController: React.FC<AccessibilityControllerProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center md:justify-start md:p-4 pointer-events-none" role="dialog" aria-modal="true" aria-labelledby="a11y-title">
