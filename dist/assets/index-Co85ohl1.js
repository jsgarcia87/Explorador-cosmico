...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:yn,depthTest:!1,depthWrite:!1})}function ul(){return new ot({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:uo(),fragmentShader:`
		...
		`,blending:yn,depthTest:!1,depthWrite:!1})}function dl(){return new ot({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:uo(),fragmentShader:`
	...
	`}function dp(i){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){const l=o.mapping,u=l===xs||l===Ms,c=l===Fi||l===Oi;if(u||c){let f=e.get(o);const d=f!==void 0?f.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==d)return t===null&&(t=new ll(i)),f=u?t.fromEquirectangular(o,f):t.fromCubemap(o,f),f.texture.pmremVersion=o.pmremVersion,e.set(o,f),f.texture;if(f!==void 0)return f.texture;{const m=o.image;return u&&m&&m.height>0||c&&m&&a(m)?(t===null&&(t=new ll(i)),f=u?t.fromEquirectangular(o):t.fromCubemap(o),f.texture.pmremVersion=o.pmremVersion,e.set(o,f),o.addEventListener("dispose",r),f.texture):null}}}return o}function a(o){let l=0;const u=6;for(let c=0;c<u;c++)o[c]!==void 0&&l++;return l===u}function r(o){const l=o.target;l.removeEventListener("dispose",r);const u=e.get(l);u!==void 0&&(e.delete(l),u.dispose())}function s(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:s}}function hp(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let a;switch(n){case"WEBGL_depth_texture":a=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":a=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":a=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":a=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:a=i.getExtension(n)}return e[n]=a,a}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const a=t(n);return a===null&&aa("THREE.WebGLRenderer: "+n+" extension not supported."),a}}}function fp(i,e,t,n){const a={},r=new WeakMap;function s(f){const d=f.target;d.index!==null&&e.remove(d.index);for(const g in d.attributes)e.remove(d.attributes[g]);for(const g in d.morphAttributes){const v=d.morphAttributes[g];for(let p=0,h=v.length;p<h;p++)e.remove(v[p])}d.removeEventListener("dispose",s),delete a[d.id];const m=r.get(d);m&&(e.remove(m),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function o(f,d){return a[d.id]===!0||(d.addEventListener("dispose",s),a[d.id]=!0,t.memory.geometries++),d}function l(f){const d=f.attributes;for(const g in d)e.update(d[g],i.ARRAY_BUFFER);const m=f.morphAttributes;for(const g in m){const v=m[g];for(let p=0,h=v.length;p<h;p++)e.update(v[p],i.ARRAY_BUFFER)}}function u(f){const d=[],m=f.index,g=f.attributes.position;let v=0;if(m!==null){const E=m.array;v=m.version;for(let b=0,M=E.length;b<M;b+=3){const D=E[b+0],w=E[b+1],A=E[b+2];d.push(D,w,w,A,A,D)}}else if(g!==void 0){const E=g.array;v=g.version;for(let b=0,M=E.length/3-1;b<M;b+=3){const D=b+0,w=b+1,A=b+2;d.push(D,w,w,A,A,D)}}else return;const p=new(fc(d)?_c:vc)(d,1);p.version=v;const h=r.get(f);h&&e.remove(h),r.set(f,p)}function c(f){const d=r.get(f);if(d){const m=f.index;m!==null&&d.version<m.version&&u(f)}else u(f);return r.get(f)}return{get:o,update:l,getWireframeAttribute:c}}function pp(i,e,t){let n;function a(d){n=d}let r,s;function o(d){r=d.type,s=d.bytesPerElement}function l(d,m){i.drawElements(n,m,r,d*s),t.update(m,n,1)}function u(d,m,g){g!==0&&(i.drawElementsInstanced(n,m,r,d*s,g),t.update(m,n,g))}function c(d,m,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,m,0,r,d,0,g);let p=0;for(let h=0;h<g;h++)p+=m[h];t.update(p,n,1)}function f(d,m,g,v){if(g===0)return;const p=e.get("WEBGL_multi_draw");if(p===null)for(let h=0;h<d.length;h++)u(d[h]/s,m[h],v[h]);else{p.multiDrawElementsInstancedWEBGL(n,m,0,r,d,0,v,0,g);let h=0;for(let E=0;E<g;E++)h+=m[E]*v[E];t.update(h,n,1)}}this.setMode=a,this.setIndex=o,this.render=l,this.renderInstances=u,this.renderMultiDraw=c,this.renderMultiDrawInstances=f}function mp(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,s,o){switch(t.calls++,s){case i.TRIANGLES:t.triangles+=o*(r/3);break;case i.LINES:t.lines+=o*(r/2);break;case i.LINE_STRIP:t.lines+=o*(r-1);break;case i.LINE_LOOP:t.lines+=o*r;break;case i.POINTS:t.points+=o*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",s);break}}function a(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:a,update:n}}function gp(i,e,t){const n=new WeakMap,a=new Ze;function r(s,o,l){const u=s.morphTargetInfluences,c=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,f=c!==void 0?c.length:0;let d=n.get(o);if(d===void 0||d.count!==f){let x=function(){R.dispose(),n.delete(o),o.removeEventListener("dispose",x)};var m=x;d!==void 0&&d.texture.dispose();const g=o.morphAttributes.position!==void 0,v=o.morphAttributes.normal!==void 0,p=o.morphAttributes.color!==void 0,h=o.morphAttributes.position||[],E=o.morphAttributes.normal||[],b=o.morphAttributes.color||[];let M=0;g===!0&&(M=1),v===!0&&(M=2),p===!0&&(M=3);let D=o.attributes.position.count*M,w=1;D>e.maxTextureSize&&(w=Math.ceil(D/e.maxTextureSize),D=e.maxTextureSize);const A=new Float32Array(D*w*4*f),R=new mc(A,D,w,f);R.type=Mn,R.needsUpdate=!0;const y=M*4;for(let C=0;C<f;C++){const H=h[C],O=E[C],X=b[C],j=D*w*4*C;for(let V=0;V<H.count;V++){const Z=V*y;g===!0&&(a.fromBufferAttribute(H,V),A[j+Z+0]=a.x,A[j+Z+1]=a.y,A[j+Z+2]=a.z,A[j+Z+3]=0),v===!0&&(a.fromBufferAttribute(O,V),A[j+Z+4]=a.x,A[j+Z+5]=a.y,A[j+Z+6]=a.z,A[j+Z+7]=0),p===!0&&(a.fromBufferAttribute(X,V),A[j+Z+8]=a.x,A[j+Z+9]=a.y,A[j+Z+10]=a.z,A[j+Z+11]=X.itemSize===4?a.w:1)}}d={count:f,texture:R,size:new Ee(D,w)},n.set(o,d),o.addEventListener("dispose",x)}if(s.isInstancedMesh===!0&&s.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",s.morphTexture,t);else{let g=0;for(let p=0;p<u.length;p++)g+=u[p];const v=o.morphTargetsRelative?1:1-g;l.getUniforms().setValue(i,"morphTargetBaseInfluence",v),l.getUniforms().setValue(i,"morphTargetInfluences",u)}l.getUniforms().setValue(i,"morphTargetsTexture",d.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:r}}function vp(i,e,t,n){let a=new WeakMap;function r(l){const u=n.render.frame,c=l.geometry,f=e.get(l,c);if(a.get(f)!==u&&(e.update(f),a.set(f,u)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),a.get(l)!==u&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),a.set(l,u))),l.isSkinnedMesh){const d=l.skeleton;a.get(d)!==u&&(d.update(),a.set(d,u))}return f}function s(){a=new WeakMap}function o(l){const u=l.target;u.removeEventListener("dispose",o),t.remove(u.instanceMatrix),u.instanceColor!==null&&t.remove(u.instanceColor)}return{update:r,dispose:s}}class bc extends It{constructor(e,t,n,a,r,s,o,l,u,c=Li){if(c!==Li&&c!==zi)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&c===Li&&(n=oi),n===void 0&&c===zi&&(n=Bi),super(null,a,r,s,o,l,c,n,u),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=o!==void 0?o:rn,this.minFilter=l!==void 0?l:rn,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const Tc=new It,hl=new bc(1,1),wc=new mc,Ac=new id,Cc=new Sc,fl=[],pl=[],ml=new Float32Array(16),gl=new Float32Array(9),vl=new Float32Array(4);function Xi(i,e,t){const n=i[0];if(n<=0||n>0)return i;const a=e*t;let r=fl[a];if(r===void 0&&(r=new Float32Array(a),fl[a]=r),e!==0){n.toArray(r,0);for(let s=1,o=0;s!==e;++s)o+=t,i[s].toArray(r,o)}return r}function mt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function gt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function vr(i,e){let t=pl[e];t===void 0&&(t=new Int32Array(e),pl[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function _p(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function xp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(mt(t,e))return;i.uniform2fv(this.addr,e),gt(t,e)}}function Mp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(mt(t,e))return;i.uniform3fv(this.addr,e),gt(t,e)}}function Sp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(mt(t,e))return;i.uniform4fv(this.addr,e),gt(t,e)}}function yp(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(mt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),gt(t,e)}else{if(mt(t,n))return;vl.set(n),i.uniformMatrix2fv(this.addr,!1,vl),gt(t,n)}}function Ep(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(mt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),gt(t,e)}else{if(mt(t,n))return;gl.set(n),i.uniformMatrix3fv(this.addr,!1,gl),gt(t,n)}}function bp(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(mt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),gt(t,e)}else{if(mt(t,n))return;ml.set(n),i.uniformMatrix4fv(this.addr,!1,ml),gt(t,n)}}function Tp(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function wp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(mt(t,e))return;i.uniform2iv(this.addr,e),gt(t,e)}}function Ap(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(mt(t,e))return;i.uniform3iv(this.addr,e),gt(t,e)}}function Cp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(mt(t,e))return;i.uniform4iv(this.addr,e),gt(t,e)}}function Rp(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Pp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(mt(t,e))return;i.uniform2uiv(this.addr,e),gt(t,e)}}function Lp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(mt(t,e))return;i.uniform3uiv(this.addr,e),gt(t,e)}}function Dp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(mt(t,e))return;i.uniform4uiv(this.addr,e),gt(t,e)}}function Ip(i,e,t){const n=this.cache,a=t.allocateTextureUnit();n[0]!==a&&(i.uniform1i(this.addr,a),n[0]=a);let r;this.type===i.SAMPLER_2D_SHADOW?(hl.compareFunction=hc,r=hl):r=Tc,t.setTexture2D(e||r,a)}function Up(i,e,t){const n=this.cache,a=t.allocateTextureUnit();n[0]!==a&&(i.uniform1i(this.addr,a),n[0]=a),t.setTexture3D(e||Ac,a)}function Np(i,e,t){const n=this.cache,a=t.allocateTextureUnit();n[0]!==a&&(i.uniform1i(this.addr,a),n[0]=a),t.setTextureCube(e||Cc,a)}function Fp(i,e,t){const n=this.cache,a=t.allocateTextureUnit();n[0]!==a&&(i.uniform1i(this.addr,a),n[0]=a),t.setTexture2DArray(e||wc,a)}function Op(i){switch(i){case 5126:return _p;case 35664:return xp;case 35665:return Mp;case 35666:return Sp;case 35674:return yp;case 35675:return Ep;case 35676:return bp;case 5124:case 35670:return Tp;case 35667:case 35671:return wp;case 35668:case 35672:return Ap;case 35669:case 35673:return Cp;case 5125:return Rp;case 36294:return Pp;case 36295:return Lp;case 36296:return Dp;case 35678:case 36198:case 36298:case 36306:case 35682:return Ip;case 35679:case 36299:case 36307:return Up;case 35680:case 36300:case 36308:case 36293:return Np;case 36289:case 36303:case 36311:case 36292:return Fp}}function Bp(i,e){i.uniform1fv(this.addr,e)}function zp(i,e){const t=Xi(e,this.size,2);i.uniform2fv(this.addr,t)}function Hp(i,e){const t=Xi(e,this.size,3);i.uniform3fv(this.addr,t)}function Gp(i,e){const t=Xi(e,this.size,4);i.uniform4fv(this.addr,t)}function kp(i,e){const t=Xi(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function Vp(i,e){const t=Xi(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function Wp(i,e){const t=Xi(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function Xp(i,e){i.uniform1iv(this.addr,e)}function qp(i,e){i.uniform2iv(this.addr,e)}function jp(i,e){i.uniform3iv(this.addr,e)}function Yp(i,e){i.uniform4iv(this.addr,e)}function $p(i,e){i.uniform1uiv(this.addr,e)}function Kp(i,e){i.uniform2uiv(this.addr,e)}function Zp(i,e){i.uniform3uiv(this.addr,e)}function Jp(i,e){i.uniform4uiv(this.addr,e)}function Qp(i,e,t){const n=this.cache,a=e.length,r=vr(t,a);mt(n,r)||(i.uniform1iv(this.addr,r),gt(n,r));for(let s=0;s!==a;++s)t.setTexture2D(e[s]||Tc,r[s])}function em(i,e,t){const n=this.cache,a=e.length,r=vr(t,a);mt(n,r)||(i.uniform1iv(this.addr,r),gt(n,r));for(let s=0;s!==a;++s)t.setTexture3D(e[s]||Ac,r[s])}function tm(i,e,t){const n=this.cache,a=e.length,r=vr(t,a);mt(n,r)||(i.uniform1iv(this.addr,r),gt(n,r));for(let s=0;s!==a;++s)t.setTextureCube(e[s]||Cc,r[s])}function nm(i,e,t){const n=this.cache,a=e.length,r=vr(t,a);mt(n,r)||(i.uniform1iv(this.addr,r),gt(n,r));for(let s=0;s!==a;++s)t.setTexture2DArray(e[s]||wc,r[s])}function im(i){switch(i){case 5126:return Bp;case 35664:return zp;case 35665:return Hp;case 35666:return Gp;case 35674:return kp;case 35675:return Vp;case 35676:return Wp;case 5124:case 35670:return Xp;case 35667:case 35671:return qp;case 35668:case 35672:return jp;case 35669:case 35673:return Yp;case 5125:return $p;case 36294:return Kp;case 36295:return Zp;case 36296:return Jp;case 35678:case 36198:case 36298:case 36306:case 35682:return Qp;case 35679:case 36299:case 36307:return em;case 35680:case 36300:case 36308:case 36293:return tm;case 36289:case 36303:case 36311:case 36292:return nm}}class am{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Op(t.type)}}class rm{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=im(t.type)}}class sm{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const a=this.seq;for(let r=0,s=a.length;r!==s;++r){const o=a[r];o.setValue(e,t[o.id],n)}}}const jr=/(\w+)(\])?(\[|\.)?/g;function _l(i,e){i.seq.push(e),i.map[e.id]=e}function om(i,e,t){const n=i.name,a=n.length;for(jr.lastIndex=0;;){const r=jr.exec(n),s=jr.lastIndex;let o=r[1];const l=r[2]==="]",u=r[3];if(l&&(o=o|0),u===void 0||u==="["&&s+2===a){_l(t,u===void 0?new am(o,i,e):new rm(o,i,e));break}else{let f=t.map[o];f===void 0&&(f=new sm(o),_l(t,f)),t=f}}}class ar{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<n;++a){const r=e.getActiveUniform(t,a),s=e.getUniformLocation(t,r.name);om(r,s,this)}}setValue(e,t,n,a){const r=this.map[t];r!==void 0&&r.setValue(e,n,a)}setOptional(e,t,n){const a=t[n];a!==void 0&&this.setValue(e,n,a)}static upload(e,t,n,a){for(let r=0,s=t.length;r!==s;++r){const o=t[r],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,a)}}static seqWithValue(e,t){const n=[];for(let a=0,r=e.length;a!==r;++a){const s=e[a];s.id in t&&n.push(s)}return n}}function xl(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const lm=37297;let cm=0;function um(i,e){const t=i.split(`
`),n=[],a=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let s=a;s<r;s++){const o=s+1;n.push(`${o===e?">":" "} ${o}: ${t[s]}`)}return n.join(`
`)}const Ml=new Ue;function dm(i){Ve._getMatrix(Ml,Ve.workingColorSpace,i);const e=`mat3( ${Ml.elements.map(t=>t.toFixed(4))} )`;switch(Ve.getTransfer(i)){case mr:return[e,"LinearTransferOETF"];case Ke:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function Sl(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),a=i.getShaderInfoLog(e).trim();if(n&&a==="")return"";const r=/ERROR: 0:(\d+)/.exec(a);if(r){const s=parseInt(r[1]);return t.toUpperCase()+`

`+a+`

`+um(i.getShaderSource(e),s)}else return a}function hm(i,e){const t=dm(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function fm(i,e){let t;switch(e){case mu:t="Linear";break;case gu:t="Reinhard";break;case vu:t="Cineon";break;case Ql:t="ACESFilmic";break;case xu:t="AgX";break;case Mu:t="Neutral";break;case _u:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Wa=new P;function pm(){Ve.getLuminanceCoefficients(Wa);const i=Wa.x.toFixed(4),e=Wa.y.toFixed(4),t=Wa.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function mm(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(ra).join(`
`)}function gm(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function vm(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let a=0;a<n;a++){const r=i.getActiveAttrib(e,a),s=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),t[s]={type:r.type,location:i.getAttribLocation(e,s),locationSize:o}}return t}function ra(i){return i!==""}function yl(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function El(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const _m=/^[ \t]*#include +<([\w\d./]+)>/gm;function Ks(i){return i.replace(_m,Mm)}const xm=new Map;function Mm(i,e){let t=Fe[e];if(t===void 0){const n=xm.get(e);if(n!==void 0)t=Fe[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Ks(t)}const Sm=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function bl(i){return i.replace(Sm,ym)}function ym(i,e,t,n){let a="";for(let r=parseInt(e);r<parseInt(t);r++)a+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return a}function Tl(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function Em(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Kl?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Zl?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===_n&&(e="SHADOWMAP_TYPE_VSM"),e}function bm(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Fi:case Oi:e="ENVMAP_TYPE_CUBE";break;case pr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Tm(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Oi:e="ENVMAP_MODE_REFRACTION";break}return e}function wm(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Jl:e="ENVMAP_BLENDING_MULTIPLY";break;case fu:e="ENVMAP_BLENDING_MIX";break;case pu:e="ENVMAP_BLENDING_ADD";break}return e}function Am(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Cm(i,e,t,n){const a=i.getContext(),r=t.defines;let s=t.vertexShader,o=t.fragmentShader;const l=Em(t),u=bm(t),c=Tm(t),f=wm(t),d=Am(t),m=mm(t),g=gm(r),v=a.createProgram();let p,h,E=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
    ...
    `,vertexColors:!0,transparent:!0,depthWrite:!1,blending:Ft}),f=new po(n,c);return i.add(f),f}function Og(i,e){const t=new ht;return i.add(t),typeof Hn<"u"&&Hn.forEach(n=>{const a=new ht;t.add(a),n.stars&&n.stars.length&&n.stars.forEach((u,c)=>{const f=Math.max(.8,3.2-Math.max(-1.5,u.mag)*.45),d=new ct(f,16,16),m=new ri({color:n.color||16777215}),g=new He(d,m);if(g.position.set(...u.p),a.add(g),u.mag<=2.2){const v=new xa(f*4.5,f*4.5),p=new ri({map:vo,color:n.color||16777215,transparent:!0,opacity:.75,blending:Ft,depthWrite:!1}),h=new He(v,p);h.position.copy(g.position),h.onBeforeRender=(E,b,M)=>{h.quaternion.copy(M.quaternion)},a.add(h)}});const r=[];n.lines&&n.lines.length&&n.stars&&n.lines.forEach(u=>{const c=n.stars[u[0]]?.p,f=n.stars[u[1]]?.p;if(c&&f){const d=[new P(...c),new P(...f)],m=new pt().setFromPoints(d),g=new ho({color:n.color||8490232,transparent:!0,opacity:.65,linewidth:1.5,blending:Ft}),v=new Pc(m,g);a.add(v),r.push(g)}});const s=new ct(2.5,16,16),o=new ri({color:n.color||16777215,transparent:!0,opacity:.01}),l=new He(s,o);l.position.set(...n.pos),a.add(l),e[n.id]={mesh:l,data:n,group:a,lineMaterials:r,type:"constelacion"}}),t}function Bg(i,e){const t=new ht,n=new ht;i.add(t),i.add(n);const a=new ct(4.8,64,64),r=new ot({uniforms:{uTime:{value:0},uMap:{value:Dg()}},vertexShader:`
      varying vec2 vUv;
      varying vec3 vNormal;
      varying vec3 vPos;
      void main() {
  ...
  `};function Gg(i={}){const e=new ht;e.name="nebula_system";const t=i.radius||22,n=new ct(t,32,32),a=new ot({vertexShader:ns.vertexShader,fragmentShader:ns.fragmentShader,uniforms:Vn.clone(ns.uniforms),side:St,transparent:!0,depthWrite:!1,blending:Ft}),r=new He(n,a);return r.name="nebula_raymarch_mesh",e.add(r),e.userData={material:a,update:(s,o,l=1,u)=>{a.uniforms.uTime.value=o,u&&a.uniforms.uCameraPos&&a.uniforms.uCameraPos.value.copy(u),e.rotation.y+=s*.02*l}},e}function kg(i,e){const t=new ht;t.name="deep_space_group",i.add(t);{const n=tn.find(a=>a.id==="agujero");if(n){const a=zg(n.relativityParams||{});a.position.set(...n.pos),t.add(a),e[n.id]={mesh:a,data:n,shaderMat:a.userData.shaderMat,s2Star:a.userData.s2Star,mat:a.userData.shaderMat,isRelativisticBlackHole:!0}}}{const n=tn.find(a=>a.id==="pulsar");if(n){const a=Hg();a.position.set(...n.pos),t.add(a),e[n.id]={mesh:a,data:n,surfaceMat:a.userData.surfaceMat,coneMat:a.userData.coneMat,mat:a.userData.surfaceMat}}}{const n=tn.find(a=>a.id==="nebulosa");if(n){const a=Gg();a.position.set(...n.pos),t.add(a),e[n.id]={mesh:a,data:n,mat:a.userData.material}}}{const n=tn.find(a=>a.id==="gigante");if(n){const a=new ct(14,64,64),r=new ot({uniforms:{uTime:{value:0},uColorDark:{value:new he(9109504)},uColorBright:{value:new he(16729344)}},vertexShader:`
          varying vec3 vNormal;
          varying vec3 vPos;
          void main() {
            vNormal = normalize(normalMatrix * normal);
  ...
  `};xo=new Uc(Xg);st.addPass(xo);st.lensingPass=xo;const Oc=new Gi(new Ee(window.innerWidth,window.innerHeight),.65,.4,.85);st.addPass(Oc);st.bloomPass=Oc;let as=0,rs=performance.now(),Ja="high";function qg(){as++;const i=performance.now();if(i-rs>=3e3){const e=as/((i-rs)/1e3);as=0,rs=i,e<24&&Ja==="high"?(Ja="medium",Vt.setPixelRatio(Math.min(window.devicePixelRatio||1,1.5)),st&&st.bloomPass&&st.bloomPass.resolution.set(window.innerWidth*.5,window.innerHeight*.5)):e<18&&Ja==="medium"&&(Ja="low",Vt.setPixelRatio(1),st&&st.bloomPass&&(st.bloomPass.strength=.4),st.lensingPass&&(st.lensingPass.enabled=!1))}}let ss=null;const jg=5e3;function Bc(){document.body.classList.remove("ui-hidden"),ss&&clearTimeout(ss),ss=setTimeout(()=>{!document.getElementById("infoPanel").classList.contains("show")&&!document.getElementById("tourBar").classList.contains("show")&&!document.getElementById("modalOverlay").classList.contains("show")&&document.body.classList.add("ui-hidden")},jg)}["mousemove","mousedown","touchstart","keydown","wheel"].forEach(i=>{window.addEventListener(i,Bc,{passive:!0})});Bc();let Rt="solar",xt=1,zc="primaria",fr=null,Mo=null,li=0,sr=!0,ua=null;const Yg=9e4;function So(){sr&&(ua&&clearTimeout(ua),ua=setTimeout(()=>{$g()},Yg))}function $g(){Rn("🏛️ Modo Museo: Reiniciando para el próximo explorador...",4e3),si("solar"),xr(),Vc(),Eo(),An("sol"),xt=1,Sa(1),rt.targetRadius=145,rt.targetTheta=.9,rt.targetPhi=1.15,rt.target.set(0,0,0)}function Kg(){rt.cameraDriftMode=!rt.cameraDriftMode;const i=document.getElementById("btnDriftTop");i&&i.classList.toggle("active-drift",rt.cameraDriftMode),Rn(rt.cameraDriftMode?"🛸 Deriva Telescópica ACTIVADA (JWST/Hubble Micro-drift)":"🎯 Deriva Telescópica DESACTIVADA",3e3)}function Zg(){sr=!sr;const i=document.getElementById("kioskBadge"),e=document.getElementById("btnKiosk");sr?(i.classList.remove("inactive"),i.innerHTML="🏛️ Modo Museo: ACTIVO",e.classList.add("active-kiosk"),Rn("🏛️ Modo Kiosco de Museo activado (Auto-reset tras 90s)",3e3),So()):(i.classList.add("inactive"),i.innerHTML="🏛️ Modo Museo: INACTIVO",e.classList.remove("active-kiosk"),ua&&clearTimeout(ua),Rn("Modo Kiosco desactivado",2500))}["mousemove","mousedown","touchstart","keydown","click"].forEach(i=>{window.addEventListener(i,So,{passive:!0})});So();function si(i){Rt=i,document.getElementById("btnSolar").classList.toggle("active",Rt==="solar"),document.getElementById("btnDeep").classList.toggle("active",Rt==="deep");const e=document.getElementById("btnConstelaciones");e&&e.classList.toggle("active",Rt==="constelaciones"),Rt==="solar"?(rr.visible=!0,is.visible=!0,Ui.visible=!1,typeof ti<"u"&&(ti.visible=!1),wn.castShadow=!0,rt.target.set(0,0,0),rt.targetRadius=145,Hc()):Rt==="deep"?(rr.visible=!1,is.visible=!1,Ui.visible=!0,typeof ti<"u"&&(ti.visible=!1),wn.castShadow=!1,rt.target.set(0,-2,-26),rt.targetRadius=160,Jg()):Rt==="constelaciones"&&(rr.visible=!1,is.visible=!1,Ui.visible=!1,typeof ti<"u"&&(ti.visible=!0),wn.castShadow=!1,rt.target.set(0,0,0),rt.targetRadius=290,Qg()),xr()}const ki=document.getElementById("planetChips");function Hc(){ki.innerHTML="",Ii.forEach(i=>{const e=document.createElement("button");e.className="planet-chip",e.innerHTML=`<span style="color:#${i.color.toString(16).padStart(6,"0")}">●</span> ${i.name}`,e.onclick=()=>An(i.id),ki.appendChild(e)})}function Jg(){ki.innerHTML="",tn.forEach(i=>{const e=document.createElement("button");e.className="planet-chip",e.innerHTML=`✦ ${i.name.split(" ")[0]}`,e.onclick=()=>An(i.id),ki.appendChild(e)})}function Qg(){ki.innerHTML="",typeof Hn<"u"&&Hn.forEach(i=>{const e=document.createElement("button");e.className="planet-chip",e.innerHTML=`✨ ${i.name.split(" ")[0]}`,e.onclick=()=>An(i.id),ki.appendChild(e)})}Hc();const sa=new Set;function An(i){const e=Mt[i];if(!e)return;fr=e.data,Ii.some(n=>n.id===i)&&Rt!=="solar"&&si("solar"),tn.some(n=>n.id===i)&&Rt!=="deep"&&si("deep"),typeof Hn<"u"&&Hn.some(n=>n.id===i)&&Rt!=="constelaciones"&&si("constelaciones");const t=new P;e.mesh.getWorldPosition(t),rt.target.copy(t),Rt==="solar"?rt.targetRadius=e.data.id==="sol"?18:e.data.radius*6.5:Rt==="constelaciones"?(rt.targetRadius=310,typeof Hn<"u"&&Hn.forEach(n=>{const a=n.id===i,r=Mt[n.id];r&&r.lineMaterials&&r.lineMaterials.forEach(s=>{s.opacity=a?1:.28,s.color.setHex(a?16436245:n.color||8490232),s.linewidth=a?2.5:1})})):rt.targetRadius=e.data.id==="agujero"?24:e.data.id==="nebulosa"?42:28,Gc(fr),document.getElementById("infoPanel").classList.add("show"),sa.add(i),s0()}function yo(i){zc=i,document.querySelectorAll(".edu-tab").forEach(e=>e.classList.remove("active")),document.getElementById(`tab${i.charAt(0).toUpperCase()+i.slice(1)}`).classList.add("active"),fr&&Gc(fr)}function Gc(i){document.getElementById("infoType").textContent=i.type,document.getElementById("infoTitle").textContent=i.name;const e=i.descLevels&&i.descLevels[zc]||i.desc;document.getElementById("infoDesc").textContent=e;const t=document.getElementById("scaleComparator");i.scaleComp?(t.style.display="flex",document.getElementById("scaleRefBadge").textContent=`Ref: ${i.scaleComp.ref}`,document.getElementById("scaleSizeText").textContent=i.scaleComp.sizeStr,document.getElementById("scaleMassText").textContent=i.scaleComp.massStr):t.style.display="none";const n=document.getElementById("nasaTelemetryHud");n&&(i.teff||i.spectralClass||i.mass||i.keplerianVelocity)?(n.style.display="block",document.getElementById("telemClass").textContent=i.spectralClass||"N/A",document.getElementById("telemTeff").textContent=i.teff?`${i.teff} K`:"N/A",document.getElementById("telemMass").textContent=i.mass||"N/A",document.getElementById("telemLuminosity").textContent=i.luminosity||"N/A",document.getElementById("telemVelocity").textContent=i.keplerianVelocity||"N/A",document.getElementById("telemDensity").textContent=i.density||"N/A"):n&&(n.style.display="none");const a=document.getElementById("relativityControls");a&&(i.id==="agujero"?(a.style.display="block",e0()):a.style.display="none");const r=document.getElementById("infoFacts");r.innerHTML="",(i.facts||[]).forEach(s=>{const o=document.createElement("li");o.textContent=s,r.appendChild(o)}),document.getElementById("infoFun").textContent=i.fun||""}function xr(){document.getElementById("infoPanel").classList.remove("show")}function e0(i){const e=Mt.agujero;if(!e||!e.shaderMat)return;const t=document.getElementById("sliderMass"),n=document.getElementById("valMass"),a=document.getElementById("sliderAccretion"),r=document.getElementById("valAccretion"),s=document.getElementById("sliderInclination"),o=document.getElementById("valInclination"),l=document.getElementById("sliderDoppler"),u=document.getElementById("valDoppler"),c=document.getElementById("btnGeodesicGrid");if(t&&n&&(t.value=e.shaderMat.uniforms.uMass?e.shaderMat.uniforms.uMass.value:1,n.textContent=`${parseFloat(t.value).toFixed(2)} M_☉`,t.oninput=f=>{const d=parseFloat(f.target.value);n.textContent=`${d.toFixed(2)} M_☉`,e.shaderMat.uniforms.uMass&&(e.shaderMat.uniforms.uMass.value=d)}),a&&r&&(a.value=e.shaderMat.uniforms.uAccretionRate?e.shaderMat.uniforms.uAccretionRate.value:1.2,r.textContent=parseFloat(a.value).toFixed(2),a.oninput=f=>{const d=parseFloat(f.target.value);r.textContent=d.toFixed(2),e.shaderMat.uniforms.uAccretionRate&&(e.shaderMat.uniforms.uAccretionRate.value=d)}),s&&o&&(s.value=e.shaderMat.uniforms.uInclination?e.shaderMat.uniforms.uInclination.value:.15,o.textContent=`${parseFloat(s.value).toFixed(2)} rad`,s.oninput=f=>{const d=parseFloat(f.target.value);o.textContent=`${d.toFixed(2)} rad`,e.shaderMat.uniforms.uInclination&&(e.shaderMat.uniforms.uInclination.value=d)}),l&&u&&(l.value=e.shaderMat.uniforms.uDopplerStrength?e.shaderMat.uniforms.uDopplerStrength.value:1.35,u.textContent=`${parseFloat(l.value).toFixed(2)}x`,l.oninput=f=>{const d=parseFloat(f.target.value);u.textContent=`${d.toFixed(2)}x`,e.shaderMat.uniforms.uDopplerStrength&&(e.shaderMat.uniforms.uDopplerStrength.value=d)}),c){let f=e.shaderMat.uniforms.uShowGeodesicGrid?e.shaderMat.uniforms.uShowGeodesicGrid.value>.5:!1;c.textContent=f?"ACTIVA (ON)":"INACTIVA",f?c.classList.add("active"):c.classList.remove("active"),c.onclick=()=>{f=!f,e.shaderMat.uniforms.uShowGeodesicGrid&&(e.shaderMat.uniforms.uShowGeodesicGrid.value=f?1:0),c.textContent=f?"ACTIVA (ON)":"INACTIVA",f?c.classList.add("active"):c.classList.remove("active")}}}{const i=document.getElementById("infoPanel");let e=0,t=0,n=!1;i.addEventListener("touchstart",a=>{const r=a.touches[0];(a.target.closest(".drawer-handle")||i.scrollTop<=0)&&(e=r.clientY,t=e,n=!0)},{passive:!0}),i.addEventListener("touchmove",a=>{if(!n)return;t=a.touches[0].clientY;const r=t-e;r>0&&(i.style.transform=`translateY(${r}px)`,i.style.transition="none")},{passive:!0}),i.addEventListener("touchend",()=>{if(!n)return;n=!1;const a=t-e;i.style.transition="",i.style.transform="",a>80&&xr()})}function t0(){const i=document.getElementById("modalOverlay"),e=document.getElementById("modalContent");e.innerHTML=`
  ...
  `,i.classList.add("show")}function kc(){const i=Nc[Mo];if(!i)return;const e=i.steps[li];document.getElementById("tourStepBadge").textContent=`${i.title} — Paso ${li+1} de ${i.steps.length}`,document.getElementById("tourStepTitle").textContent=e.title,An(e.id)}function n0(){const i=Nc[Mo];i&&(li<i.steps.length-1?(li++,kc()):(Rn("🎉 ¡Has completado el tour didáctico con éxito!",4e3),Eo()))}function i0(){li>0&&(li--,kc())}function Eo(){Mo=null,li=0,document.getElementById("btnTours").classList.remove("active-tour"),document.getElementById("tourBar").classList.remove("show")}const Xl=Pg;function a0(){const i=Xl[Math.floor(Math.random()*Xl.length)],e=document.getElementById("modalOverlay"),t=document.getElementById("modalContent");let n="";i.opts.forEach((a,r)=>{n+=`<div class="tour-card" onclick="checkQuizAnswer(${r}, ${i.ans}, '${i.exp.replace(/'/g,"\\'")}')">
